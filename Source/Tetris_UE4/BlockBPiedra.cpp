...
ABlockBPiedra::ABlockBPiedra()
{
	...
	Material1 = Cast<UMaterial>(StaticLoadObject(UMaterial::StaticClass(), nullptr, TEXT("Material'/Game/StarterContent/Materials/M_CobbleStone_Rough.M_CobbleStone_Rough'")));
	Mesh->SetMaterial(0, Material1);
}

void ABlockBPiedra::SetMaterial(FString myMaterial)
{
	Material = myMaterial;
}
