...
ABlockBMadera::ABlockBMadera()
{
	...
	Material1 = Cast<UMaterial>(StaticLoadObject(UMaterial::StaticClass(), nullptr, TEXT("Material'/Game/StarterContent/Materials/M_Wood_Oak.M_Wood_Oak'")));
		Mesh->SetMaterial(0, Material1);
}
void ABlockBMadera::SetMaterial(FString myMaterial)
{
	Material = myMaterial;
}
